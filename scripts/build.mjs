...
const faviconDataUrl = `data:image/svg+xml;base64,${Buffer.from(await readText("assets/favicon.svg")).toString("base64")}`;
...
const renderHead = ({ prefix, code = false }) => {
  const codeStyle = code
    ...
    : "";
  return `<link rel="icon" type="image/svg+xml" href="${faviconDataUrl}" />
